      ...
      {hasAlerts && (
        <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="font-bold text-amber-800">Atenção Necessária</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {stats.pendingPayments.length > 0 && (
              <div className="bg-white/60 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-semibold text-amber-800">Pagamentos Pendentes</span>
                ...
                {stats.pendingPayments.length > 3 && (
                  <button
                    ...
                    className="text-xs text-amber-700 hover:text-amber-900 mt-2 flex items-center gap-1"
                  >
            ...
            {stats.todayCheckOuts.length > 0 && (
              <div className="bg-white/60 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-semibold text-amber-800">Check-outs Hoje</span>
                  <span className="text-xs bg-amber-200 text-amber-800 px-2 py-0.5 rounded-full font-bold">
                    {stats.todayCheckOuts.length}
                  </span>
                </div>
                <div className="space-y-1">
